...
@section('content')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>Thống kê</strong> tài khoản quản lý</h3>
        </div>
        <div class="col-auto ms-auto text-end mt-n1">
            <a href="{{ route('adminaccount.create') }}" class="btn btn-primary">Thêm mới quản lý</a>
        </div>
    </div>
    <div class="row">
                                        ...
                                        <div class="modal fade" id="editModal-{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action="{{ route('adminaccount.update', $user->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
