...
@section('content')
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>Thống kê</strong> thành viên</h3>
        </div>

        <div class="col-auto ms-auto text-end mt-n1">
            <a href="{{ route('members.create') }}" class="btn btn-primary">Thêm mới thành viên</a>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class="text-center">
                                    ...
                                    @foreach ($members as $member)
                                        <tr>
                                            ...
                                            <td class="table-action text-center">
                                                <a href="{{ route('members.edit', $member->alias) }}"
                                                 ...
                                                 <form action="{{ route('members.destroy', $member->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-danger"
                                                        onclick="return confirm('Bạn có chắc chắn muốn xóa thành viên này?')"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                               ...
                                               <a href="{{ route('members.detail', $member->alias) }}"
                                    ...
                                    @else
                                    <tr class="text-center">
                                        <td colspan="4">Không có thành viên nào</td>
